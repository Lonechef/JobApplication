package com.Saumya.JobApp.repo;
...
public class JobRepo {
    //So basically What we want is to display all the job posts on our web page
    //Now service layer will call out the repo package and take that

    //So currently not  using DB so we will manually have some JobPosts
